 ...
 * @subpackage Vbi_Newsletters/admin
 */
...
class Vbi_Newsletters_Admin {
	...
	public function enqueue_styles() {
		...
		// wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/vbi-newsletters-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		// wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/vbi-newsletters-admin.js',  array( $this->plugin_name.'-blockUI',$this->plugin_name.'-validate','jquery' ), $this->version, false );
